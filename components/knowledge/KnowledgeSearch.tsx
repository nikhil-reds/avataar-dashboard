...
const CONTROL_CLASS =
  'text-xs px-2.5 py-2 border border-zinc-200 dark:border-zinc-700 rounded-lg bg-white dark:bg-zinc-900 outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 cursor-pointer';

/**
 * Filters live in the URL rather than in component state, so the server component above
 * re-queries the database and a shared link reproduces the same view.
 */
    ...
    <div className="flex items-center gap-3 flex-wrap">
      <div className="relative flex-1 min-w-[260px]">
        ...
        <input
          ...
          placeholder="Search title, content, keywords, category or source…"
